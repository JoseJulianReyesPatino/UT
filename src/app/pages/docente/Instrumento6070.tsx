...
const ponderacionesOpciones = ["60%", "65%", "70%"];
...
export default function Instrumento6070Page() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>Formulario Instrumento 60/70</CardTitle><CardDescription>Los campos marcados con * son obligatorios.</CardDescription></CardHeader>
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-border rounded-lg p-6 text-center hover:border-success/50 transition-colors">
              ...
              <label htmlFor="instrumento-60-upload" className="cursor-pointer block space-y-2"><Upload className="h-8 w-8 mx-auto text-muted-foreground"/><p className="text-sm font-medium">{getArchivosLabel()}</p><p className="text-xs text-muted-foreground">{getEspaciosLabel()}</p></label>
            </div>
