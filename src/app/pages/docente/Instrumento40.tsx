...
export default function Instrumento40Page({ deadlineInfo }: { deadlineInfo?: { formattedDeadline: string; isUrgent: boolean } | null }) {
  const { user } = useAuth();
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="rounded-2xl border-2 border-emerald-500 bg-emerald-50 px-4 py-4 text-sm shadow-md shadow-emerald-500/20 ring-1 ring-emerald-500/40 dark:border-emerald-400 dark:bg-emerald-950/30">
                <span className="block text-base font-semibold text-slate-900 dark:text-white">Plan Nuevo Modelo</span>
