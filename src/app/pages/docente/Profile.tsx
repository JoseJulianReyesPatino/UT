...
export function Profile({ onDirtyChange }: Readonly<{ onDirtyChange?: (dirty: boolean) => void }> = {}) {
  ...
  return (
    <div className="relative">
      <div className="relative z-10 space-y-6">
        ...
        {/* Tres columnas como tarjetas independientes */}
  ...
  <div
    className="h-40 w-40 shrink-0 rounded-full overflow-hidden ring-2 ring-emerald-200/60 dark:ring-emerald-900/40 cursor-pointer"
              ...
              <div className="flex flex-col items-center gap-1.5 w-full">
                <Button
                  ...
                  className="w-full rounded-2xl dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800"
                >
                ...
                {(selectedAvatarFile || hasServerAvatar) && (
                  <Button
                    ...
                    disabled={isRemovingAvatar || isSavingProfile}
                    className="w-full rounded-2xl dark:hover:bg-slate-800 dark:text-slate-300"
                  >
  ...
  />
              ...
              <div className="space-y-1.5">
                ...
                <Input 
                  value={user?.email ?? ""} 
                  disabled 
                  className="h-11 rounded-2xl bg-muted/40 dark:bg-slate-900/50 dark:text-slate-400 dark:border-slate-700" 
                />
              </div>
